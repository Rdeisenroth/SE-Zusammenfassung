...
\begin{itemize}
    ...
    \item Viele Verknüpfungen von Stabilen Bausteinen (Libaries, z.B. aus der Java-Standartbibliothek) ist kein Problem
\end{itemize}
...
\begin{itemize}
    \item API-Kommentare:\begin{itemize}
              ...
              \item Zielgruppe: Andere Entwickler, die den Code als Libary/Framework nutzen
...
\begin{table}[ht]
    ...
    \begin{tabular}{l}
        ...
        \midrule
        4.\quad\mlcell[l]{
            \fakebullet{}\textbf{Konzequenzen}: Nebenwirkungen, Einschränkungen, Auswirkungen auf Flexibilität, Erweiterbarkeit und Portabilität
        }                                                                                                 \\
        \midrule
        5.\quad\mlcell[l]{
...
\paragraph{Black Box}\begin{itemize}
    ...
    \item Probleme: Libary Calls, Unnötige Testfälle, rekursion, \dots
\end{itemize}
\vspace*{-1ex}
...
\begin{enumerate}
    ...
    \item Software stack (Libaries und so) hat sich weiterentwickelt
\end{enumerate}
